...
<body>
    ...
    <main>
        <div class="el-line">
            <div class="jumbotron jumbotron-fluid rty" style="background-color: #c0c0c0;">
                <div class="container">
                    <div class="fixed-top ft1">
                        <div class="size_text_index">
                            <h3>Timur Gayazov | Frontend developer</h3>
                        </div>
                    </div>
                    <br>
                    <br>
                    ...
                    <br>
                    <div class="ava_index">
                        <img src="./images/avatar.jpg" class="rounded mx-auto d-block border-0">
                    </div>
                </div>
            </div>
            ...
            <div class="jumbotron jumbotron-fluid qwe" style="background-color: #d3d3d3;">
                <div class="container">
                    ...
                    <div class="col-8 mx-auto rounded main_text_index">
                        ...
                        <br>
                        <br>
                        <h1>Hi, My Name is Timur Gayazov.</h1>
                        <h5 class="text-secondary">Website Developer. Russian Born. Speak fluent social.</h5>
                        <!-- <br> -->
                        ...
                        <br>
                        <div class="mx-auto rounded col-10 fx_bot">
