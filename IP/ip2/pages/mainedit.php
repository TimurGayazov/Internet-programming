<?php
    ...
    if($_SESSION['user']['role'] != "Main Admin"){
...
<body>
    ...
    <main>
        ...
        <div class="text-center">
          <form class="text-center" action="../inc/update_adm.php" method="post" enctype="multipart/form-data">
            ...
            <label>Score</label>
            <input type="text" name="score" placeholder="Enter new score" value="<?= $li['score']?>">
            <label>Role</label>
            <input type="text" name="role" placeholder="Enter new role" value="<?= $li['role']?>">
            <label>Password</label>
            <input type="password" required name="password" placeholder="Enter new password" value="<?= $li['password']?>">
            <br>
            <button type="submit">Update information</button>
            <br>
            <a href="../inc/users_for_adm.php" style="color:red; border:2px solid red; text-decoration:none;"><h5>Cancel</h5></a>
